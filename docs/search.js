var project_collection_name = "oeml-play"

const typesenseInstantsearchAdapter = new TypesenseInstantSearchAdapter({
    server: {
        apiKey: "faiZVgHaaadT9EYQFi7auS48LxHAhY4y",
        nodes: [
            {
...
search.addWidgets([
    ...
    instantsearch.widgets.hits({
        ...
        templates: {
            ...
            ${hit.authors.map((item) => html`<a href='${item.id}'><span class="badge rounded-pill m-1 bg-success">${item}</span></a>`)}</p>`;
            },
        },
    }),
    ...
    instantsearch.widgets.refinementList({
        container: "#refinement-list-jobs",
        attribute: "jobs",
        searchable: true,
        cssClasses: {
            showMore: "btn btn-secondary btn-sm align-content-center",
